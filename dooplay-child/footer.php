...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // 1. FADE OUT when current page is fully loaded
    window.addEventListener("load", function() {
        loader.classList.add("loader-hidden");
    });

    // 2. SMART CLICK DETECTION (Prevents loader on download/new tab)
    ...
    links.forEach(link => {
        link.addEventListener("click", function(e) {
            ...
            if (
                ...
                href.includes("javascript") ||    // JS link
                target === "_blank" ||            // New Tab
                e.ctrlKey || e.metaKey ||         // Holding Ctrl/Cmd
                href.includes(".zip") ||          // Download file
                href === window.location.href     // Same Page
            ) {
                return; 
            }
    ...
    // 3. BACK BUTTON FIX (Safari/Chrome Cache)
